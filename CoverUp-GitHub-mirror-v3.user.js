...
(function() {
    ...
    // No cap — kept uncapped deliberately (removed a 20,000-entry eviction limit that
    // was silently dropping the oldest entries once a site-wide scan history grew past
    // it, which looked like the counter had "stopped" even though scanning itself was
    // still working fine).
    ...
    function addScannedCollageDescriptions(ids) {
        ...
        GM_setValue('coverup_scanned_collage_desc', JSON.stringify([...set]));
    }
